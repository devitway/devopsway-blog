...
Чем ближе к единице -- тем больше общего в значении, даже если сами слова разные. 0 -- ничего общего, 1 -- одно и то же. На практике score выше 0.8 -- хорошее совпадение. Именно поэтому векторный поиск находит "проксирование запросов" по запросу "reverse proxy", а `LIKE '%proxy%'` -- нет.
