...
При cosine similarity: 0.95 -- высокая семантическая близость, этот фрагмент почти наверняка релевантен запросу. 0.45 -- слабое совпадение, фрагмент скорее всего не о том. На практике порог отсечения обычно 0.7-0.8.
