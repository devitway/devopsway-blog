...
А теперь альтернативная реальность: скрипт каждые 5 минут проверял диск. Когда заполнение перевалило за 85%, он отправил алерт в Telegram. Вы ещё спали, но уже знали про проблему. Утром -- спокойно почистил, без паники.
...
Каждый уровень убирает человека из цепочки. Цель -- чтобы сервер сам сообщал о проблемах, а не вы ходили и проверяли.
