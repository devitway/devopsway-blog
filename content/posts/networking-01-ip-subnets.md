...
**1993 – CIDR (RFC 1519).** Оригинальная система классов (A, B, C) расходовала адреса неэффективно: класс B = 65 536 адресов, класс C = 256. CIDR (бесклассовая адресация) позволил делить сети произвольно: /24, /25, /22 – любой размер.
...
**1998 – IPv6 (RFC 2460).** 128 бит = 3.4 × 10^38 адресов. В 2026 году всё ещё не вытеснил IPv4 полностью.
...
/32: формула 2^n-2 тут неприменима – это один адрес (host route)
...
Минус два – сетевой адрес и broadcast (см. блок "Формула" выше).
...
**На собесе:** проговори минус два и добавь про /31 (RFC 3021) – это отличает того, кто зубрил, от того, кто понимает.
...
**На собесе:** ключевое – классы A/B/C давали только фиксированные размеры, CIDR даёт точный (/20 вместо выбора между /16 и /24). Это отсрочило исчерпание IPv4 на десятилетия.
