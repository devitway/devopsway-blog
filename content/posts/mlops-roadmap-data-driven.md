...
Мы пошли другим путём. Вместо экспертных мнений – данные.

---

## Методология: откуда данные

Мы собрали и проанализировали **838 вакансий** из двух источников:
...
Для каждой вакансии мы извлекли: название роли, технологический стек, зарплатную вилку, требования к английскому, формат работы.

Из 566 вакансий getmatch – **62 с чистым заголовком «MLOps»**. Это наша контрольная группа – те, кого рынок буквально называет MLOps-инженерами.
...
Вот инструменты, которые roadmap.sh ставит на видное место, но в 838 вакансиях мы нашли **ноль упоминаний**:
...
[SFIA 9](https://sfia-online.org/) содержит навык **MLNG (Machine Learning)** – уровни L2 через L6. Мы наложили на него реальные стеки из вакансий:
