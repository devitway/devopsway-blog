...
Языковые модели полезны, но ставить их барьером между упавшим сервисом и дежурным инженером – преступление. Модель должна стоять сбоку от цепочки оповещения.
