...
function initSystemsThinkingAssessment() {
    ...
    widget.innerHTML = `
        <div class="assessment-note">
          <p>📌 <strong>Примечание:</strong> Технологии, упомянутые в примерах (например: Terraform, Prometheus, Kubernetes), приведены для ориентира. Если вы выполняете аналогичные задачи с другими инструментами — смело отмечайте соответствующий пункт.</p>
        </div>
